                    ...
                    <template v-if="batteryConfigList.zendure.connection_type == 1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div
                                    v-if="
                                        batteryConfigList.zendure.server != 'mqtt.zen-iot.com' &&
                                        batteryConfigList.zendure.server != 'mqtt-eu.zen-iot.com' &&
                                        batteryConfigList.zendure.server
                                    "
                                    class="alert alert-warning"
                                    role="alert"
                                    v-html="$t('batteryadmin.zendure.serverWarning')"
                                ></div>
                                <div
                                    class="alert alert-info"
                                    role="alert"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div
                                    v-if="
                                        batteryConfigList.zendure.secret.length != 36 &&
