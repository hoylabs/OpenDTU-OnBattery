...
void Provider::onMessage(twai_message_t rx_message)
{
    switch (rx_message.identifier) {
        case 0x351: {
            ...
            if (_verboseLogging) {
                MessageOutput.printf("[JkBmsCan] chargeVoltage: %f chargeCurrentLimitation: %f dischargeCurrentLimitation: %f dischargeVoltageLimitation: %f\r\n",
        ...
        case 0x355: {
            ...
            if (_verboseLogging) {
                MessageOutput.printf("[JkBmsCan] soc: %f soh: %d\r\n",
        ...
        case 0x359: {
            ...
            if (_verboseLogging) {
                MessageOutput.printf("[JkBmsCan] Modules: %d\r\n",
                        _stats->_moduleCount);
            }
...
void Provider::dummyData()
{
    ...
    _stats->setManufacturer("JkBmsCan US3000C");
