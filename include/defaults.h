...
#define POWERLIMITER_GRID_VOLTAGE_THROTTLING_ENABLED false
#define POWERLIMITER_GRID_VOLTAGE_UPPER_THRESHOLD 253.0
#define POWERLIMITER_GRID_VOLTAGE_LOWER_THRESHOLD 245.0
#define POWERLIMITER_GRID_VOLTAGE_MAX_THROTTLING 50
