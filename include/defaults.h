...
#define BATTERY_ZENDURE_CHARGE_THROUGH_ENABLE false
...
#define HUAWEI_OFFLINE_VOLTAGE 48.0
#define HUAWEI_OFFLINE_CURRENT 0.0
#define HUAWEI_INPUT_CURRENT_LIMIT 0.0
