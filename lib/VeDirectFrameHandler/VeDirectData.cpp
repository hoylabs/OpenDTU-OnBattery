...
frozen::string const& veStruct::getPidAsString() const
{
	 ...
	 * [1] but rev2 in [2].
	 * all remaining PIDs are sourced from [3], which is used as the single
	 * source of truth, including for resolving conflicts such as rev2 vs. rev3.
	 *
	 ...
	 * [3] VictronConnect Android App (https://github.com/hoylabs/victron-product-ids)
	 */
	static constexpr frozen::map<uint16_t, frozen::string, 121> values = {
		{ 0x0108, "BlueSolar Charger MPPT 150/70" },
		{ 0x0200, "BMV-600S" },
		{ 0x0201, "BMV-602S" },
		{ 0x0202, "BMV-600HS" },
		{ 0x0203, "BMV-700" },
		{ 0x0204, "BMV-702" },
		{ 0x0205, "BMV-700H" },
		{ 0x0300, "BlueSolar Charger MPPT 70/15" },
		...
		{ 0xA07F, "All-In-1 Solar Charger MPPT 75/15" },
		{ 0xA080, "SmartSolar Charger MPPT 250/60 rev3" },
		{ 0xA081, "SmartSolar Charger MPPT 250/70 rev3" },
		...
		{ 0xA118, "SmartSolar MPPT RS 450/100" },
		{ 0xA119, "SmartSolar MPPT RS 450/200" },
		...
		{ 0xC039, "SmartShunt IP65 300A" },
		{ 0xC03A, "SmartShunt 500A" },
		{ 0xC03B, "SmartShunt 300A" }
	};
